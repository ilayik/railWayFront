  ...
  <div>
    ...
    <v-container >
      <v-row justify="center">
        ...
        <v-col cols="12" sm="5" md="12" v-if="freeNameStatus">
          <v-data-table
              :headers="headers"
              :items="desserts"
              sort-by="calories"
        ...
        if (this.check) {
          if (this.stationName !== '') {
            if (this.stationName === station.name) {
              this.stationNameMessage = 'Number "' + this.stationName + '" is used';
              this.freeNameStatus = false;
              this.check = false;
            } else {
              this.stationNameMessage = 'Login "' + this.stationName + '" is free';
              this.station.name = this.trainNumber;
