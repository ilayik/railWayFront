                ...
                this.axios.post(this.url.login, this.AuthenticationRequestDTO)
                    .then(response => {
                            if (response.status === 200) {
                                ...
                                console.log('Токен выдан и записан в cookie ', Cookies.get('Token'))
                                console.log('Login выдан и записан в cookie ', Cookies.get('Login'))
                                console.log('Role user ', response.data.role);
